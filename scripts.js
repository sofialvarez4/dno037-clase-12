const datos = [
    {
        picsum: "https://picsum.photos/id/103/900/600",
    ...
    {
        picsum: "https://picsum.photos/id/407/900/600",
    ...
    {
        picsum: "https://picsum.photos/id/8/900/600",
...
async function users() {
    ...
    resultados.forEach((p) => {
        document.getElementById("personas").innerHTML +=
            ...
            ", " +
            p.location.country +
            " <br><i class='bi bi-envelope-heart'></i>";
    });
}
